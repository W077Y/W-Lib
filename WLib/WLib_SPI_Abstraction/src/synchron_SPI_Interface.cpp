...
void throw_multible_active_con_error() { throw WLib::Internal::char_const_ptr_exception("Invalid use. There is already an active connection."); }
#else
void throw_multible_active_con_error()
{
  // Invalid use. There is already an active connection.
  while (true)
    ;
}
#endif // !WLIB_NO_THROW
