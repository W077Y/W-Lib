...
namespace WLib
{
  ...
  {
  public:
    using payload_t = typename WLib::Publisher_Interface<T>::payload_t;

    SPSC_Subscriber(WLib::Publisher_Interface<T>& pub)
        : WLib::Publisher_Interface<T>::Subscriber_Interface(pub)
    {
    }
